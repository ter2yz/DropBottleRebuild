    ...
    <div>
      <div className="w-full">
        <div className="w-full bg-white">
          ...
          >
            <path
              id="Path_3"
              data-name="Path 3"
              d="M-86,2017.083s249.617-207.3,670.338-120,496.076,166.734,777.862,147.694,471.8-97.493,471.8-97.493V2068H-86Z"
              transform="translate(86 -1875.625)"
              fill="#f3bca8"
            />
          </svg>
        </div>
        ...
        >
            ...
            <div className="w-full my-10 flex flex-col lg:flex-row items-center lg:items-start justify-center">
              <div className="w-full flex flex-col items-center lg:items-start lg:w-4/12">
                ...
                <h2
                  ...
                  className="uppercase font-montserrat font-bold text-3xl mb-5 leading-none text-center lg:text-left text-white"
                >
                  Detox water
                  <br />
                  on the go
          ...
          <div
            className="absolute inset-0 w-full h-full bg-no-repeat bg-left-bottom bg-contain"
            style={{ backgroundImage: `url(${BottleWaterImage})` }}
          ></div>
        </div>
        <div className="w-full bg-white">
          <svg
          ...
          >
            <path
              data-name="Path 4"
              d="M1916.384,3104s-1549.337,52-1920,300V3104Z"
              transform="translate(3.616 -3104)"
              fill="#f3bca8"
            />
          </svg>
        </div>
